  ...
  submitButtonFn() {
    ...
    service.bindPhone({
      ...
      if (res.data.code === 0) {
        ...
        setTimeout(()=>{
          if(that.data.source=="scanPickUp"){//扫码取件
            wx.redirectTo({url:"../../pages/scanPickUp/index"})
          }else if(that.data.source=="expressNotTake"){
            wx.redirectTo({url:"../../pages/expressNotTake/index"})
          }else{
            //返回
            wx.navigateBack();
          }
